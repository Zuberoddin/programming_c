//performing the matrix_substraction using functions
#include<stdio.h>
#define ROW 3
#define COL 4
...
int main(void)
{
	...
	matrix_substraction(m1,m2,m3,ROW,COL);
...
void matrix_substraction(int (*m1)[COL],int (*m2)[COL],int (*m3)[COL],int r,int e)
{
	//int m3[r][e]
	int i,j;
	for(i=0;i<r;i++)
