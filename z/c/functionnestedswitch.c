...
void main(void)
{
	int num,opt,res,bin,num1,num2,num3,i,fact=1,num4,a,b;
	char sub_opt;
	while(1)
	{
		printf("Menu\n 0.exit\n 1.reverse_integer&factorial_number\n 2.binary_decimal\n 3.decimal_binary\n 4.sum_digits\n 5.polyndrome_problem\n");
		...
		case 0:
			exit(0);
		case 1:printf("select the option a or b\n a.reverse_integer\n b.factorial_number\n");
			__fpurge(stdin);
			scanf("%c",&sub_opt);
			switch(sub_opt)
			{
